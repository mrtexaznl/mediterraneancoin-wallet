...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("mediterraneancoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No MediterraneanCoin application found.\nPlease install MediterraneanCoin Wallet.", Toast.LENGTH_LONG).show();
